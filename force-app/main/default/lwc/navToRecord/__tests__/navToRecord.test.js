...
// the apex mock is standard with sfdx-@lwc/engine-dom-jest,
...
jest.mock(
    ...
    () => {
        ...
        } = require('@salesforce/sfdx-@lwc/engine-dom-jest');
        return {
...
describe('c-nav-to-record', () => {
    ...
    it('navigates to record view', async () => {
        ...
        // Create initial @lwc/engine-dom element and attach to virtual DOM
