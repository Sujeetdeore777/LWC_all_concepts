...
describe('c-view-source', () => {
    ...
    it('renders an a href that points to the @lwc/engine-dom Recipes GitHub repo', () => {
        const BASE_URL =
            'https://github.com/trailheadapps/@lwc/engine-dom-recipes/tree/main/force-app/main/default/';
